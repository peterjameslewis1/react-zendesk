    ...
    return (
        <div className="section-2-container__sales-info">
            ...
            <div className="section-2-container__sales-info-text-container">
                ...
                <a href="#" className="btn-blue">Watch video</a>
            </div>
            <div className="section-2-container__sales-info-text-container" id="staples-content">
            <img src="https://d1eipm3vz40hy0.cloudfront.net/images/p-home/redesign-2019/logos/logo-staples.svg" alt=""/>
            ...
            <div className="section-2-container__sales-info__img">
                <img className="section-2-container__sales-info__img-primary" src="https://d1eipm3vz40hy0.cloudfront.net/images/p-home/redesign-2019/use-cases/photo/use-case-sales-2x.jpg" alt=""/>

                <img className="section-2-container__sales-info__img-secondary-sales" src="https://d1eipm3vz40hy0.cloudfront.net/images/p-home/redesign-2019/use-cases/screenshot/screenshot-sales-2x.png" alt=""/>
            </div>
